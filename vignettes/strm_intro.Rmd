...
We load the shapefile in using the `readOGR()` from the `rgdal` package. 
...
nbknn <- knn2nb(col.knn, row.names = sptdmg$STFID)
...
moran.test(sptdmg$LNP1000, listwk, alternative = "two.sided")
moran.test(sptdmg$LNP0090, listwk, alternative = "two.sided")
moran.test(sptdmg$POLD00, listwk, alternative = "two.sided")
moran.test(sptdmg$PUNMP00, listwk, alternative = "two.sided")
moran.test(sptdmg$ACSAIR, listwk, alternative = "two.sided")
moran.test(sptdmg$PFRST, listwk, alternative = "two.sided")
moran.test(sptdmg$DEVPB, listwk, alternative = "two.sided")

formulatest <- as.formula(LNP1000 ~ LNP0090 + POLD00 + PUNMP00 + ACSAIR + PFRST + DEVPB )
m2 <- lm(formulatest, data = sptdmg)
summary(m2)
