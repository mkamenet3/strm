...
out <- strm(formula, id="state", data=Produc, listw= usalw, time=2,trans="log",wide=FALSE,year==1970 | year==1971)
summary(out)
...
res <- strm(formula, id=id, data=sptdmg_long, listw= listwk, time=2,trans=NULL,wide=TRUE)
