...
The first data set we will use is the **Produc** data set from the [`Ecdat` package](https://cran.r-project.org/web/packages/Ecdat/index.html). This data set is a panel of United States production data from 1970-1986. There are 816 observations by county in the United States. The variables we will use are:
